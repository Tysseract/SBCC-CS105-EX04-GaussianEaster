...
The purpose of this assignment is for you to write more of your own comments, to express solutions to complex problems using variables to make them more readable, and finally, to take complex descriptions of mathematical formulas and translate them into Java code. 
...
Like our last exercise, we are going to do this exercise by writing the source code that solves the problem first in **GaussianEaster.java**. Using the techniques shown on the web page titled [How to Start Every Project in this Class](http://209.129.49.15:7990/projects/CS105/repos/allan.knight/browse/HowToStartEveryProject.md) create a source file called **GaussianEaster.java**. This is where your code will go. Replace the code in that file with the code in the grey box below:
